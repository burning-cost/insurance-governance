...
This library produces validation and MRM governance artefacts for UK insurance pricing models. The regulatory context — PRA SS1/23, FCA Consumer Duty — is specific and the outputs need to be accurate. Contributions that improve regulatory alignment or practical usability are welcome.
...
If the bug relates to a specific SS1/23 test being computed incorrectly, cite the relevant section of the supervisory statement. Regulatory accuracy matters here.
...
- Docstrings follow NumPy format and cite the relevant regulatory reference (SS1/23 section, FCA principle, or Equality Act section) where a method implements a specific requirement
